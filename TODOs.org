...
* TODO mapped-vars and mapped-funcs.                                  :BASIC:
  - <2016-12-28 Wed>



* TODO simple evaluators per builtin-ops.                             :BASIC:
  - <2016-12-28 Wed>

* TODO eq, ne for func-literals? builtin-ops                          :DEBUG:
  - <2016-12-28 Wed> almost everything!

    
* TODO docstrings for func-val, func-val-params.                        :ADV:
  - <2016-12-29 Thu>
...
* TODO ~Comments~ on everywhere?                                        :ADV:
